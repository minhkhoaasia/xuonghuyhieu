...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_nhap-don-dat-hang}","click",function(sym,e){window.open("http://www.xuonghuyhieu.com/lien-he","_self");});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_dat-hang-ngay}","click",function(sym,e){window.open("http://www.xuonghuyhieu.com/lien-he","_self");});
//Edge binding end
